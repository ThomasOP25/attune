...
The focus score is then sent via OSC to a Max MSP patch that plays a continuous tone. When the focus score is low, the tone is interrupted by dissonance and chaos, showing the meditator that they have lost their concentration. While the meditator's focus score is high, the tone remains stable and harmonious. 
